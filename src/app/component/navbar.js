...
export default function Navbar() {
  ...
  // NEW: scroll par navbar ke Part 2 (logo/search/icons) ko collapse karne
  // aur category row ko transparent/glassy banane ke liye scroll state track kiya
  ...
  return (
    <>
     <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm ">
        ...
        {/* scroll hote hi background transparent/glassy ho jata hai */}
        <div
          className={`border-t border-gray-100 overflow-x-hidden transition-colors duration-300 ${
            scrolled
