...
function ProductDetailsPage({ initialProduct = null, initialProductId = "" }) {
        ...
        "ProductDetailsPage.useEffect": ()=>{
            ...
            const loadWishlistFromBackend = {
                "ProductDetailsPage.useEffect.loadWishlistFromBackend": async ()=>{
                    ...
                    const localItems = Array.isArray(savedItems) ? savedItems : [];
                    try {
                        ...
                        if (!divid) {
                            if (active_0) setWishlistItems(localItems);
                            return;
                        }
    ...
    const liked = product ? wishlistItems.some((item)=>{
        ...
        return itemProductId === product.id || item.id === product.id || item.productId === product.id;
    }) : false;
    ...
    const handleToggleWishlist = async ()=>{
        ...
        const existingItem = wishlistItems.find((item_2)=>{
            ...
            return itemProductId_0 === product.id || item_2.id === product.id || item_2.productId === product.id;
        });
        ...
        try {
            ...
            const localItems_0 = Array.isArray(savedItems_0) ? savedItems_0 : [];
            if (existingItem) {
                // optimistic remove
                setWishlistItems((prev_2)=>prev_2.filter((item_3)=>{
                        const itemProductId_1 = item_3.pid && typeof item_3.pid === "object" ? item_3.pid._id : item_3.pid;
                        return itemProductId_1 !== product.id && item_3.id !== product.id && item_3.productId !== product.id;
                    }));
                localStorage.setItem("wishlistItems", JSON.stringify(localItems_0.filter((item_4)=>item_4.id !== product.id && item_4.productId !== product.id)));
                if (existingItem._id) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteWishlistItem"])(existingItem._id);
            } else {
                const localProduct = {
                    id: product.id,
                    productId: product.id,
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        4,
                                                        5
                                                    ].map((item_5)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$star$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Star$3e$__["Star"], {
                                                            size: 14,
                                                            fill: "currentColor"
                                                        }, item_5, false, {
                                                            fileName: "[project]/src/app/ProductDetailpage/productdetails.js",
...
//# sourceMappingURL=src_app_03fitt0._.js.map