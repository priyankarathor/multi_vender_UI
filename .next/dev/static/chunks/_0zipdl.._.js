...
const getWishlistVendorId = (item)=>{
    const vendor = item?.vendorId || item?.venderid || item?.vendor_id || item?.vendor || (item?.pid && typeof item.pid === "object" ? item.pid.vendorId : null) || (item?.variantId && typeof item.variantId === "object" ? item.variantId.vendorId : null);
...
const getName = (item)=>{
    ...
    return item?.product_name || item?.productName || product?.productName || product?.itemName || product?.name || product?.title || null;
};
const getPrice = (item)=>{
    const product = getProduct(item);
    return item?.variantId?.offer?.salePrice || item?.variantId?.offer?.sellingPrice || item?.variantId?.sellingPrice || item?.variantId?.price || item?.unit_price || item?.price || product?.offer?.salePrice || product?.offer?.sellingPrice || product?.sellingPrice || product?.price || null;
};
const getImage = (item)=>{
    const product = getProduct(item);
    return item?.variantId?.images?.[0] || item?.variantId?.image || item?.image || item?.image_url || product?.images?.[0] || product?.image || product?.image_url || null;
};
// Item ko wishlist mein tabhi rakho jab uske paas
// valid _id, product id, name, price aur image ho.
// Agar kuch bhi missing hai, item ko drop kar do.
const isValidWishlistItem = (item)=>{
    if (!item?._id) return false;
    if (!getWishlistProductId(item)) return false;
    if (!getName(item)) return false;
    const price = getPrice(item);
    if (price === null || price === undefined || Number(price) <= 0) return false;
    if (!getImage(item)) return false;
    return true;
};
const hydrateWishlistItem = async (item)=>{
    if (isValidWishlistItem(item)) return item;
    const productId = getWishlistProductId(item);
    if (!productId) return item;
    try {
        const product = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$products$2f$products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchProductById"])(productId);
        ...
        return {
            ...
            pid: {
                ...
                price: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$products$2f$products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductPrice"])(product),
                image: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$products$2f$products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductImage"])(product)
            }
        };
    } catch  {
        return item;
...
function WishlistPage() {
    ...
    const [wishlistReady, setWishlistReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const fetchWishlist = async ()=>{
        try {
            ...
            const hydratedItems = await Promise.all(items.map(hydrateWishlistItem));
            // Sirf complete/valid items hi state mein rakho
            const validItems = hydratedItems.filter(isValidWishlistItem);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WishlistPage.useEffect": ()=>{
            ...
            const refreshWishlist = {
                "WishlistPage.useEffect.refreshWishlist": ()=>{
                    fetchWishlist();
                }
            }["WishlistPage.useEffect.refreshWishlist"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WishlistPage.useEffect": ()=>{
            const loadCategories = {
                "WishlistPage.useEffect.loadCategories": async ()=>{
                    try {
                        ...
                        const namesById = getApiList(res_0?.data).reduce({
                            "WishlistPage.useEffect.loadCategories.namesById": (map, category)=>{
                        ...
                        }["WishlistPage.useEffect.loadCategories.namesById"], {});
                        setCategoryNamesById(namesById);
                    } catch (error_0) {
                        console.error("Failed to load wishlist categories", error_0);
                    }
                }
            }["WishlistPage.useEffect.loadCategories"];
            loadCategories();
        }
    }["WishlistPage.useEffect"], []);
    const removeFromWishlist = async (id_0)=>{
        if (!id_0) return;
        const removedItem = wishlistItems.find((item)=>item._id === id_0);
        const removedProductId = getWishlistProductId(removedItem);
        setWishlistItems((prev)=>prev.filter((item_0)=>item_0._id !== id_0));
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteWishlistItem"])(id_0);
            try {
                const savedItems = JSON.parse(localStorage.getItem("wishlistItems") || "[]");
                const nextItems = Array.isArray(savedItems) ? removedProductId ? savedItems.filter((item_1)=>String(getWishlistProductId(item_1)) !== String(removedProductId)) : savedItems : [];
            ...
            console.error("Failed to remove wishlist item", error_1);
            fetchWishlist();
        }
    };
    const changeQty = async (item_2, delta)=>{
        if (!item_2?._id) return;
        const currentQty = Number(item_2?.qty || item_2?.quantity || 1);
        const nextQty = Math.max(1, currentQty + delta);
        if (nextQty === currentQty) return;
        setWishlistItems((prev_0)=>prev_0.map((w)=>w._id === item_2._id ? {
                    ...w,
                    qty: nextQty,
                    quantity: nextQty
                } : w));
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateWishlistItem"])(item_2._id, {
                ...item_2,
                qty: nextQty,
                quantity: nextQty,
                cid: item_2?.cid || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
                pid: getWishlistProductId(item_2),
                variantId: getWishlistVariantId(item_2),
                vendorId: getWishlistVendorId(item_2)
            });
            window.dispatchEvent(new Event("wishlistUpdated"));
        } catch (error_2) {
            console.error("Failed to update wishlist qty", error_2);
            fetchWishlist();
        }
    };
    const getCategoryName = (item_3)=>{
        const product = getProduct(item_3);
        const category_0 = product?.categoryId || product?.category || item_3?.categoryId || item_3?.category;
        const categoryId = typeof category_0 === "object" ? category_0?._id : category_0;
        const categoryName = typeof category_0 === "object" ? category_0?.name || category_0?.title : null;
        return categoryName || categoryNamesById[categoryId] || product?.categoryName || item_3?.categoryName || "Product";
    };
    const getProductLink = (item_4)=>{
        const product_0 = getProduct(item_4);
        const productId = product_0?._id || getWishlistProductId(item_4);
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-11 h-11 rounded-xl bg-orange-50 flex items-center justify-center",
                ...
                wishlistItems.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-white border border-gray-200 rounded-xl p-10 text-center",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: wishlistItems.map((item_5)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-md transition",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: getProductLink(item_5),
                                    className: "block",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: getCategoryName(item_5)
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/Wishlist/page.js",
                                                lineNumber: 241,
                                                columnNumber: 21
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                "Rs. ",
                                                Number(getPrice(item_5)).toLocaleString("en-IN")
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/Wishlist/page.js",
                                            lineNumber: 252,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mt-2 flex items-center gap-2 w-fit rounded-lg border border-gray-200 px-2 py-1",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    type: "button",
                                                    onClick: ()=>changeQty(item_5, -1),
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    children: item_5?.qty || item_5?.quantity || 1
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/Wishlist/page.js",
                                                    lineNumber: 261,
                                                    columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    type: "button",
                                                    onClick: ()=>removeFromWishlist(item_5._id),
...
_s(WishlistPage, "VtiKljoSFgxG6ba9qrrL4Xynap8=");
_c = WishlistPage;
var _c;
...
//# sourceMappingURL=_0zipdl.._.js.map