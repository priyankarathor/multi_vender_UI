...
function Navbar() {
    ...
    const searchCategoryWidth = Math.min(180, Math.max(84, searchCategory.length * 9 + 54));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Navbar.useEffect": ()=>{
            ...
            const matchedCategory = categories.find({
                "Navbar.useEffect.matchedCategory": (cat)=>cat.name?.toLowerCase() === categoryName.toLowerCase()
            }["Navbar.useEffect.matchedCategory"]);
            if (matchedCategory) {
...
_s(Navbar, "Hg1iRxZtwjMs9fdVneLbD9LYLus=", false, function() {
    return [
...
"[project]/src/app/providers/GoogleAuthProvider.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GoogleAuthProvider(t0) {
    ...
    if ($[0] !== "2b29e05cd561d08e79674d2df2e75a83217925eced82c3b186fe2523ba32705d") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2b29e05cd561d08e79674d2df2e75a83217925eced82c3b186fe2523ba32705d";
    }
    const { children } = t0;
    const googleClientId = ("TURBOPACK compile-time value", "your_google_client_id_here");
...
//# sourceMappingURL=src_app_0ijqnh_._.js.map