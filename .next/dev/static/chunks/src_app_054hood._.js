...
function Navbar() {
    ...
    const handleUserLogin = async (e_1)=>{
        ...
        try {
            ...
            localStorage.setItem("user", JSON.stringify(res_2.data));
            if (res_2.data?.token) localStorage.setItem("userToken", res_2.data.token);
...
_s(Navbar, "pnOluBbO1FaT/Zc9VRGh2JBwflg=", false, function() {
    return [
...
//# sourceMappingURL=src_app_054hood._.js.map