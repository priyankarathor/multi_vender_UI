...
function ProductDetailsPage({ initialProduct = null, initialProductId = "" }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailsPage.useEffect": ()=>{
            let active_0 = true;
            const loadWishlist = {
                "ProductDetailsPage.useEffect.loadWishlist": async ()=>{
                    try {
                        const items = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadWishlistItems"])();
            ...
            }["ProductDetailsPage.useEffect.loadWishlist"];
            loadWishlist();
            return ({
                "ProductDetailsPage.useEffect": ()=>{
                    active_0 = false;
    ...
    const liked = product ? wishlistItems.some((item)=>{
        const itemProductId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item);
    ...
    const handleAddToCart = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$cart$2f$cart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCartItem"])({
                cid: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$auth$2f$session$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
                pid: product.id,
                divid: deviceId,
                qty: safeQuantity,
    ...
    const handleToggleWishlist = async ()=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleWishlistProduct"])({
                ...product,
                variantId: selectedVariant?._id || null,
...
function RelatedProducts() {
    ...
    if ($[0] !== "6ff82673c0540ce88d3453a3c1f3f0335ffdff8a64b14b78c2abcbb06ddb38e2") {
        for(let $i = 0; $i < 16; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6ff82673c0540ce88d3453a3c1f3f0335ffdff8a64b14b78c2abcbb06ddb38e2";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
        ...
        t1 = ({
            "RelatedProducts[useEffect()]": ()=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadWishlistItems"])().then({
                    "RelatedProducts[useEffect() > (anonymous)()]": (items)=>{
                        if (active) {
                            setWishlistItems(items);
                        }
                    }
                }["RelatedProducts[useEffect() > (anonymous)()]"]).catch({
                    "RelatedProducts[useEffect() > (anonymous)()]": ()=>{
                        if (active) {
                            setWishlistItems([]);
                        }
                    }
    ...
    if ($[4] !== wishlistItems) {
        t3 = ({
            "RelatedProducts[handleWishlist]": async (product)=>{
                ;
                try {
        ...
        })["RelatedProducts[handleWishlist]"];
        $[4] = wishlistItems;
        $[5] = t3;
    } else {
        t3 = $[5];
    ...
    if ($[8] !== handleWishlist || $[9] !== wishlistItems) {
        t6 = products.map({
            "RelatedProducts[products.map()]": (product_0, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    initial: {
                        opacity: 0,
                        y: 20
                    },
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: {
                                        "RelatedProducts[products.map() > <button>.onClick]": ()=>handleWishlist(product_0)
                                    }["RelatedProducts[products.map() > <button>.onClick]"],
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$heart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Heart$3e$__["Heart"], {
                                        ...
                                        fill: wishlistItems.some({
                                            "RelatedProducts[products.map() > wishlistItems.some()]": (item)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item) === product_0.id
                                        }["RelatedProducts[products.map() > wishlistItems.some()]"]) ? "currentColor" : "none"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/ProductDetailpage/RelatedProducts.js",
                                        lineNumber: 142,
                                        columnNumber: 200
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$heart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Heart$3e$__["Heart"], {
                                                size: 17,
                                                fill: wishlistItems.some({
                                                    "RelatedProducts[products.map() > wishlistItems.some()]": (item_0)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item_0) === product_0.id
                                                }["RelatedProducts[products.map() > wishlistItems.some()]"]) ? "currentColor" : "none"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/ProductDetailpage/RelatedProducts.js",
                                                lineNumber: 146,
...
_s(RelatedProducts, "LWCt+FS/fbZ0NYVmSdV1NvexBks=");
_c = RelatedProducts;
var _c;
...
//# sourceMappingURL=src_app_00jc4kj._.js.map