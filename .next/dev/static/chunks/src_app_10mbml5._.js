...
function WishlistPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WishlistPage.useEffect": ()=>{
            ...
            const refreshWishlist = {
                "WishlistPage.useEffect.refreshWishlist": ()=>fetchWishlist()
    ...
    const removeFromWishlist = async (id_0)=>{
        if (!id_0) return;
        const removedItem = wishlistItems.find((item_0)=>String(item_0._id || item_0.id) === String(id_0));
        const removedProductId = getWishlistProductId(removedItem);
        setWishlistItems((prev)=>prev.filter((item_1)=>String(item_1._id || item_1.id) !== String(id_0)));
        try {
            ...
            try {
                ...
                const nextItems = Array.isArray(savedItems) ? removedProductId ? savedItems.filter((item_2)=>String(getWishlistProductId(item_2)) !== String(removedProductId)) : savedItems : [];
    ...
    const changeQty = async (item_3, delta)=>{
        if (!item_3?._id) return;
        const currentQty = Number(item_3?.qty || item_3?.quantity || 1);
        const nextQty = Math.max(1, currentQty + delta);
        if (nextQty === currentQty) return;
        setWishlistItems((prev_0)=>prev_0.map((w)=>w._id === item_3._id ? {
                    ...w,
                    qty: nextQty,
                    quantity: nextQty
                } : w));
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateWishlistItem"])(item_3._id, {
                ...item_3,
                qty: nextQty,
                quantity: nextQty,
                cid: item_3?.cid || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
                pid: getWishlistProductId(item_3),
                variantId: getWishlistVariantId(item_3),
                vendorId: getWishlistVendorId(item_3)
            });
            window.dispatchEvent(new Event("wishlistUpdated"));
        } catch (error_2) {
    ...
    const getName = (item_4)=>{
        const product = getProduct(item_4);
        return item_4?.product_name || item_4?.productName || product?.productName || product?.itemName || product?.name || product?.title || "Untitled Product";
    };
    const getImage = (item_5)=>{
        const product_0 = getProduct(item_5);
        return item_5?.variantId?.images?.[0] || item_5?.variantId?.image || item_5?.image || item_5?.image_url || product_0?.images?.[0] || product_0?.image || product_0?.image_url || "https://via.placeholder.com/300";
    };
    const getPrice = (item_6)=>{
        const product_1 = getProduct(item_6);
        return item_6?.variantId?.offer?.salePrice || item_6?.variantId?.offer?.sellingPrice || item_6?.variantId?.sellingPrice || item_6?.variantId?.price || item_6?.unit_price || item_6?.price || product_1?.offer?.salePrice || product_1?.offer?.sellingPrice || product_1?.sellingPrice || product_1?.price || 0;
    };
    const getCategoryName = (item_7)=>{
        const product_2 = getProduct(item_7);
        const category_0 = product_2?.categoryId || product_2?.category || item_7?.categoryId || item_7?.category;
        ...
        return categoryName || categoryNamesById[categoryId] || product_2?.categoryName || item_7?.categoryName || "Product";
    };
    const getProductLink = (item_8)=>{
        const product_3 = getProduct(item_8);
        const productId = product_3?._id || getWishlistProductId(item_8);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                wishlistItems.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: wishlistItems.map((item_9, index_0)=>{
                        const itemId = item_9?._id || item_9?.id;
                        const key_0 = getWishlistKey(item_9, index_0);
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-md transition",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: getProductLink(item_9),
                                    className: "block",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: getCategoryName(item_9)
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/Wishlist/page.js",
                                                lineNumber: 208,
                                                columnNumber: 23
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                "Rs. ",
                                                Number(getPrice(item_9)).toLocaleString("en-IN")
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/Wishlist/page.js",
                                            lineNumber: 219,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    children: item_9?.qty || item_9?.quantity || 1
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/Wishlist/page.js",
                                                    lineNumber: 228,
                                                    columnNumber: 23
...
//# sourceMappingURL=src_app_10mbml5._.js.map