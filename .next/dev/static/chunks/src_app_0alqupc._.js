...
function ShopPage() {
                ...
                "ShopPage.useEffect.loadCategories": async ()=>{
                    try {
                        ...
                        const idsByName = rawCategories.reduce({
                            "ShopPage.useEffect.loadCategories.idsByName": (map_0, category_0)=>{
                                if (typeof category_0 === "string") return map_0;
                                const id_0 = category_0?._id || category_0?.id;
                                const name_0 = category_0?.name || category_0?.category || category_0?.title;
                                if (id_0 && name_0) {
                        ...
                        const apiCategories = rawCategories.map({
                            "ShopPage.useEffect.loadCategories.apiCategories": (category_1)=>typeof category_1 === "string" ? category_1 : category_1?.name || category_1?.category || category_1?.title
            ...
            const loadSubCategories = {
                "ShopPage.useEffect.loadSubCategories": async ()=>{
                    try {
                        ...
                        const list = getApiList(res_0.data);
                        const namesById_0 = list.reduce({
                            "ShopPage.useEffect.loadSubCategories.namesById_0": (map_1, subcategory)=>{
                                const id_1 = subcategory?._id || subcategory?.id;
                                const name_1 = getSubCategoryName(subcategory);
                                if (id_1 && name_1) {
                                    map_1[id_1] = name_1;
                                }
                                return map_1;
    ...
    const getCategoryName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShopPage.useCallback[getCategoryName]": (category_2)=>categoryNamesById[category_2] || category_2
    ...
    const getSubCategoryDisplayName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShopPage.useCallback[getSubCategoryDisplayName]": (subcategory_0)=>subCategoryNamesById[subcategory_0] || subcategory_0
    ...
    const toggleWishlist = (product)=>{
        setWishlistItems((prev_0)=>{
            const exists = prev_0.some((item)=>item.id === product.id);
            if (exists) {
                return prev_0.filter((item_0)=>item_0.id !== product.id);
            }
            return [
                ...prev_0,
                {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$heart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Heart$3e$__["Heart"], {
                                                        size: 15,
                                                        className: wishlistItems.some((item_1)=>item_1.id === p_5.id) ? "fill-[#FF9900] text-[#FF9900]" : "text-gray-700"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/shop/porductpage.js",
                                                        lineNumber: 617,
                                                        columnNumber: 23
...
_s(ShopPage, "AxYFB0rx7KF+CNHi0X7Np7g/B8Y=", false, function() {
    return [
...
function ShopPage() {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(2);
    if ($[0] !== "f2f6017f8993c95a03bb72a612b007db8edab0bc58a5df974d7a34d79436e9e9") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f2f6017f8993c95a03bb72a612b007db8edab0bc58a5df974d7a34d79436e9e9";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
//# sourceMappingURL=src_app_0alqupc._.js.map