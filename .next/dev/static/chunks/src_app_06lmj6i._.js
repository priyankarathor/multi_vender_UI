...
function CartPage() {
    ...
    const handleLocalLogin = async (e_0)=>{
        ...
        try {
            ...
            localStorage.setItem("user", JSON.stringify(res_0.data));
            localStorage.setItem("checkoutUser", JSON.stringify(res_0.data));
            if (res_0.data?.token) localStorage.setItem("userToken", res_0.data.token);
            setLoginForm({
                email: "",
                password: ""
            });
    ...
    const handleLocalRegister = async (e_2)=>{
        ...
        try {
            ...
            if (res_1.data?.token) localStorage.setItem("userToken", res_1.data.token);
...
//# sourceMappingURL=src_app_06lmj6i._.js.map