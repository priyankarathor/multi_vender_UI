...
const userRegister = async (data)=>{
    ...
    const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$auth$2f$session$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractCustomerId"])(res.data);
...
function CartPage() {
        ...
        "CartPage.useEffect": ()=>{
            const fetchCart = {
                "CartPage.useEffect.fetchCart": async ()=>{
                    try {
                        const cid = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("cid") : "TURBOPACK unreachable";
                        ...
                        setCartItems(items);
                        setSelectedItemIds(items.map({
                            "CartPage.useEffect.fetchCart": (item)=>item._id
                        }["CartPage.useEffect.fetchCart"]).filter(Boolean));
                    } catch (error) {
                        console.log(error);
                    } finally{
                        setLoading(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadWishlistItems"])().then({
                "CartPage.useEffect": (items_0)=>{
                    if (active) setWishlistItems(items_0);
                }
    ...
    const increaseQty = (item_5)=>{
        setCartItems((prev)=>prev.map((i)=>i._id === item_5._id ? {
                    ...i,
                    qty: getQty(item_5) + 1
                } : i));
    };
    const decreaseQty = (item_6)=>{
        const currentQty = getQty(item_6);
        if (currentQty <= 1) return;
        setCartItems((prev_0)=>prev_0.map((i_0)=>i_0._id === item_6._id ? {
                    ...i_0,
                    qty: currentQty - 1
                } : i_0));
    };
    const removeItem = (item_7)=>{
        setCartItems((prev_1)=>prev_1.filter((i_1)=>i_1._id !== item_7._id));
        setSelectedItemIds((prev_2)=>prev_2.filter((id)=>id !== item_7._id));
    };
    ...
    const toggleRecommendedWishlist = async (product_0)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleWishlistProduct"])(product_0, wishlistItems);
            if (result.changed) {
                setWishlistItems(result.items);
                window.dispatchEvent(new Event("wishlistUpdated"));
            }
        } catch (error_0) {
            console.error("Wishlist API failed", error_0);
        }
    };
    ...
    const handleLocalLogin = async (e_0)=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$auth$2f$session$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveLoginSession"])(res_0.data, {
                checkout: true
            });
            setLoginForm({
                email: "",
            ...
            const message_0 = error_1.response?.data?.message || "Login failed";
    ...
    const handleLocalRegister = async (e_2)=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$auth$2f$session$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveLoginSession"])(res_1.data, {
                checkout: true
            });
            setRegisterModalOpen(false);
            alert("Registration successful. You can proceed to checkout now.");
        } catch (error_2) {
            alert(error_2.response?.data?.message || "Registration failed");
        } finally{
    ...
    const selectedCartItems = cartItems.filter((item_8)=>selectedItemIds.includes(item_8._id));
    const subtotal = selectedCartItems.reduce((acc, item_9)=>acc + getPrice(item_9) * getQty(item_9), 0);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            cartItems.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 279,
                                columnNumber: 37
                            }, this) : cartItems.map((item_10)=>{
                                const title = getTitle(item_10);
                                const image = getImage(item_10);
                                const price = getPrice(item_10);
                                const mrp = getMrp(item_10);
                                const quantity = getQty(item_10);
                                const lineTotal = price * quantity;
                                const isSelected = selectedItemIds.includes(item_10._id);
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "checkbox",
                                                    checked: isSelected,
                                                    onChange: ()=>toggleItemSelection(item_10._id),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: recommendedProducts.map((product_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                onClick: ()=>toggleRecommendedWishlist(product_1),
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$heart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Heart$3e$__["Heart"], {
                                                                    size: 14,
                                                                    fill: wishlistItems.some((item_11)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item_11) === product_1.id) ? "currentColor" : "none"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/Addtocard/page.js",
                                                                    lineNumber: 407,
                                                                    columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                onClick: ()=>addRecommendedToCart(product_1),
...
_s(CartPage, "oMY2OdJLgCGhZLDhDLUdMZbwaIU=", false, function() {
    return [
...
//# sourceMappingURL=src_app_02lafib._.js.map