...
function ProductDetailsPage({ initialProduct = null, initialProductId = "" }) {
    ...
    const loadWishlistFromBackend = async ()=>{
        try {
            ...
            const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApiWishlistList"])(res?.data);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailsPage.useEffect": ()=>{
            let active_0 = true;
            const initialLoad = {
                "ProductDetailsPage.useEffect.initialLoad": async ()=>{
                    try {
                        const res_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWishlistByCidOrDevice"])({
                            cid: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoggedInCid"])()
                        });
                        const items_0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApiWishlistList"])(res_0?.data);
                        if (active_0) setWishlistItems(Array.isArray(items_0) ? items_0 : []);
                    } catch (err_1) {
                        if (active_0) setWishlistItems([]);
                    }
                }
            }["ProductDetailsPage.useEffect.initialLoad"];
            initialLoad();
    ...
    const liked = product ? wishlistItems.some((item)=>{
        const itemProductId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item);
    ...
    const handleAddToCart = async (openCart = true)=>{
        ...
        try {
            ...
            console.error("Cart API failed", err_2.response?.data?.message || err_2.message);
            return false;
        } finally{
    ...
    const handleToggleWishlist = async ()=>{
        ...
        const existingItem = wishlistItems.find((item_4)=>{
            const itemProductId_2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item_4);
        ...
        if (existingItem) {
            ...
            try {
                ...
                console.error("Wishlist API failed", err_3.response?.data?.message || err_3.message);
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createWishlistItem"])({
                cid: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
                pid: product.id,
                divid: deviceId_0,
                qty: 1,
            ...
            console.error("Wishlist API failed", err_4.response?.data?.message || err_4.message);
        } finally{
            setTogglingWishlist(false);
        }
    };
...
//# sourceMappingURL=src_app_0qm93aq._.js.map