...
function ProductDetailsPage({ initialProduct = null, initialProductId = "" }) {
    ...
    const handleToggleWishlist = async ()=>{
        ...
        const existingItem = wishlistItems.find((item_2)=>{
            ...
            return itemProductId_0 === product.id || item_2.productId === product.id || item_2.id === product.id;
        });
        const deviceId_1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$cart$2f$cart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCartDeviceId"])();
...
//# sourceMappingURL=src_app_04ddagp._.js.map