...
const createWishlistItem = (data)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/create`, {
        cid: data?.cid ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
        pid: data?.pid ?? null,
        divid: data?.divid || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$cart$2f$cart$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCartDeviceId"])(),
        qty: data?.qty ?? 1,
        variantId: data?.variantId ?? null,
...
const updateWishlistItem = (id, data)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`${BASE_URL}/update/${id}`, {
        cid: data?.cid ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
        pid: data?.pid ?? null,
        divid: data?.divid || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$cart$2f$cart$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCartDeviceId"])(),
        qty: data?.qty ?? 1,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$cart$2f$cart$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/apis/cart/cart.js [app-ssr] (ecmascript)"); // <-- cart wala SAME device id function use kiya
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/apis/customer/customer.js [app-ssr] (ecmascript)");
"use client";
;
;
...
function WishlistPage() {
    ...
    const getProduct = (item)=>item.pid && typeof item.pid === "object" ? item.pid : null;
    const getName = (item)=>getProduct(item)?.productName || getProduct(item)?.itemName || "Untitled Product";
    const getImage = (item)=>item.variantId?.images?.[0] || getProduct(item)?.images?.[0] || "https://via.placeholder.com/300";
    const getPrice = (item)=>item.variantId?.offer?.salePrice || item.variantId?.offer?.sellingPrice || getProduct(item)?.price || 0;
    const getCategoryName = (item)=>{
        const categoryId = getProduct(item)?.category || getProduct(item)?.categoryId;
        return categoryNamesById[categoryId] || getProduct(item)?.categoryName || "Product";
    };
    const getProductLink = (item)=>{
        const productId = getProduct(item)?._id || getItemProductId(item);
...
//# sourceMappingURL=_0052gjv._.js.map