...
async function fetchProducts(filters = {}) {
    ...
    // NAYA: banner click se aane wala vendorId — sirf jab isko explicitly
    // pass kiya jaye (jaise ShopPage banner-vendorId flow me), warna
    // normal category browsing me ye khali hi rahega, koi asar nahi padega
    if (filters.vendorId) {
...
/* =========================================================================
   NAYA: vendorId bhi string ya populated object ({ _id, name, companyname })
   dono form me aa sakta hai. Ye helper dono se safely _id nikal leta hai —
   isse banner-click flow (jo sirf ek specific vendor ke products dikhana
   chahta hai) product.vendorId se compare kar sake.
   ========================================================================= */ const extractVendorId = (value)=>{
    if (!value) return "";
    if (typeof value === "object") {
...
function ShopPage() {
    ...
    // NAYA: banner click se aane wala vendorId (agar hai to)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const loadProducts = async ()=>{
            try {
                ...
                // NAYA: sirf jab banner se vendorId aaya ho tabhi filter lagega,
                // normal category browsing pe ye khali hi rahega
                if (filters.vendorId) {
    ...
    /* ================= FILTER (client-side, on top of whatever API returned) ================= */ const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return products.filter((p)=>{
            ...
            // NAYA: agar banner se vendorId aaya hai to sirf usi vendor ke
            // products match honge; warna (normal category browsing) hamesha true
            const vendorMatch = !filters.vendorId || String(extractVendorId(p.vendorId)) === String(filters.vendorId);
            ...
            return cat && subcat && vendorMatch && search && price && rating;
        });
    }, [
        filters,
        getCategoryName,
                ...
                children: [
                    ...
                    productsLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$component$2f$PageSkeleton$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProductGridSkeleton"], {
                        ...
                        children: paginatedProducts.map((p)=>{
                            ...
                            const brandName = p.brand || p.brandName || getCategoryName(p.category) || "Product";
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                (p.isNew || p.is_new) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                (p.isSponsored || p.is_sponsored) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: `absolute right-2 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white/95 text-gray-700 shadow-sm transition hover:bg-[#FF9900] hover:text-black ${p.isSponsored || p.is_sponsored ? "top-8" : "top-2"}`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-gb2w4._.js.map