    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const loadWishlistFromBackend = async ()=>{
            ...
            try {
                ...
                if (!divid) {
                    if (active) setWishlistItems(localItems);
                    return;
                }
    ...
    const handleToggleWishlist = async ()=>{
        ...
        try {
            ...
            if (existingItem) {
                ...
                localStorage.setItem("wishlistItems", JSON.stringify(localItems.filter((item)=>item.id !== product.id && item.productId !== product.id)));
                if (existingItem._id) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteWishlistItem"])(existingItem._id);
            } else {
                const localProduct = {
                    id: product.id,
                    productId: product.id,
...
//# sourceMappingURL=src_app_0i27uwu._.js.map