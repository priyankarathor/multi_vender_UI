...
function ProductDetailsPage({ initialProduct = null, initialProductId = "" }) {
    ...
    // reusable fetcher — cart.js ke fetchCart jaisa hi pattern,
    // create/delete ke baad isi se list refresh hoti hai
    const loadWishlistFromBackend = async ()=>{
        try {
            ...
            const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApiWishlistList"])(res?.data);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const initialLoad = async ()=>{
            try {
                ...
                const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApiWishlistList"])(res?.data);
                if (active) setWishlistItems(Array.isArray(items) ? items : []);
            } catch (err) {
    ...
    const liked = product ? wishlistItems.some((item)=>{
        const itemProductId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item);
    ...
    const handleToggleWishlist = async ()=>{
        ...
        if (existingItem) {
            // optimistic remove, cart.js ke removeItem jaisa hi
            ...
            try {
                ...
                // rollback on failure, jaisa cart.js fetchCart() se karta hai
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createWishlistItem"])({
                cid: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
                pid: product.id,
                divid: deviceId,
                qty: 1,
            ...
            // create ke baad backend response shape guess nahi karte —
            // seedha poori list refresh kar lete hain (cart.js pattern)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0rkt3b-._.js.map