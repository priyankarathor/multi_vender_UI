...
const getWishlistKey = (item, index)=>{
    return item?._id || item?.wishlistId || item?.wishlist_id || item?.id || `${getWishlistProductId(item) || "product"}-${getWishlistVariantId(item) || "variant"}-${index}`;
};
function WishlistPage() {
    ...
    const [wishlistReady, setWishlistReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const removeFromWishlist = async (id)=>{
        if (!id) return;
        const removedItem = wishlistItems.find((item)=>String(item._id || item.id) === String(id));
        const removedProductId = getWishlistProductId(removedItem);
        setWishlistItems((prev)=>prev.filter((item)=>String(item._id || item.id) !== String(id)));
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteWishlistItem"])(id);
            try {
                const savedItems = JSON.parse(localStorage.getItem("wishlistItems") || "[]");
                const nextItems = Array.isArray(savedItems) ? removedProductId ? savedItems.filter((item)=>String(getWishlistProductId(item)) !== String(removedProductId)) : savedItems : [];
    ...
    const changeQty = async (item, delta)=>{
        ...
        setWishlistItems((prev)=>prev.map((w)=>w._id === item._id ? {
                    ...w,
                    qty: nextQty,
                    quantity: nextQty
                } : w));
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$wishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateWishlistItem"])(item._id, {
                ...item,
                qty: nextQty,
                quantity: nextQty,
                cid: item?.cid || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$customer$2f$customer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
                pid: getWishlistProductId(item),
                variantId: getWishlistVariantId(item),
    ...
    const getName = (item)=>{
        ...
        return item?.product_name || item?.productName || product?.productName || product?.itemName || product?.name || product?.title || "Untitled Product";
    };
    const getImage = (item)=>{
        const product = getProduct(item);
        return item?.variantId?.images?.[0] || item?.variantId?.image || item?.image || item?.image_url || product?.images?.[0] || product?.image || product?.image_url || "https://via.placeholder.com/300";
    };
    const getPrice = (item)=>{
        const product = getProduct(item);
        return item?.variantId?.offer?.salePrice || item?.variantId?.offer?.sellingPrice || item?.variantId?.sellingPrice || item?.variantId?.price || item?.unit_price || item?.price || product?.offer?.salePrice || product?.offer?.sellingPrice || product?.sellingPrice || product?.price || 0;
    };
    const getCategoryName = (item)=>{
        const product = getProduct(item);
        const category = product?.categoryId || product?.category || item?.categoryId || item?.category;
        const categoryId = typeof category === "object" ? category?._id : category;
        const categoryName = typeof category === "object" ? category?.name || category?.title : null;
        return categoryName || categoryNamesById[categoryId] || product?.categoryName || item?.categoryName || "Product";
    };
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                wishlistItems.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: wishlistItems.map((item, index)=>{
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                "Rs. ",
                                                Number(getPrice(item)).toLocaleString("en-IN")
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/Wishlist/page.js",
                                            lineNumber: 373,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    children: item?.qty || item?.quantity || 1
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/Wishlist/page.js",
                                                    lineNumber: 387,
                                                    columnNumber: 23
...
//# sourceMappingURL=_0e1~rb_._.js.map