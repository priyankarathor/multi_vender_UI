...
function ProductDetailsPage({ initialProduct = null, initialProductId = "" }) {
    ...
    // Logged-in users load wishlist by cid; guests keep using backend device id.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        let active = true;
        const loadWishlist = async ()=>{
            try {
                const items = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadWishlistItems"])();
    ...
    const liked = product ? wishlistItems.some((item)=>{
        const itemProductId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWishlistProductId"])(item);
        return itemProductId === product.id || item.productId === product.id || item.id === product.id;
    }) : false;
    ...
    const handleAddToCart = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$cart$2f$cart$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createCartItem"])({
                cid: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$auth$2f$session$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLoggedInCid"])(),
                pid: product.id,
                divid: deviceId,
                qty: safeQuantity,
    ...
    const handleToggleWishlist = async ()=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$wishlist$2f$clientWishlist$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toggleWishlistProduct"])({
                ...product,
                variantId: selectedVariant?._id || null,
...
//# sourceMappingURL=src_app_11x715d._.js.map