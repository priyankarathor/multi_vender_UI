...
async function toggleWishlistProduct(product, wishlistItems) {
    ...
    const existingItem = wishlistItems.find((item)=>getWishlistProductId(item) === productId);
    if (existingItem?._id) {
        ...
        return {
            items: wishlistItems.filter((item)=>item._id !== existingItem._id),
            changed: true
        };
    }
    const cid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$apis$2f$auth$2f$session$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLoggedInCid"])();
...
//# sourceMappingURL=src_app_0jnms_b._.js.map